...
For Objective-C projects you after importing the source files into the project you will need to import header (which is auto generated by Xcode) in your *.m file.
